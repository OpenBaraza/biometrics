...
public class VerifyDesk implements ActionListener {
	...
	public VerifyDesk(String student, Device dev) {
		...
		addField("Student ID", jStudent.getString("login_id"), 10, 10, 120, 20, 200);
		addField("Student Name", jStudent.getString("name"), 400, 10, 120, 20, 200);
		addField("Tel No", jStudent.getString("user_id"), 10, 30, 120, 20, 200);
		addField("EMail", jStudent.getString("phone_number"), 400, 30, 120, 20, 200);
		addField("Entity ID", jStudent.getString("email"), 10, 50, 120, 20, 200);
		...
		eDialog = new JDialog(eFrame , "Verify User Details", true);
